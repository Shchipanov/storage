...
const showElement = (el) => {
  const boxShadowHeight = translateRemIntoPx(parseFloat(getComputedStyle(el).getPropertyValue('--box-shadow-height'), 10)) || 0;
...
window.initCompareHeader = initCompareHeader;

export {initCompareHeader};
